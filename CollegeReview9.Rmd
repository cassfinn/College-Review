...
```
After eliminating non-accredited schools and schools which are vocational, offer y associate's degrees, and otherwise did not fit in the range of 4 
...
It would be interesting to know if there are relationships between family income and SAT scores and between annual cost and SAT scores.  It would also be interesting to see where the colleges with the highest SAT scores are located in the United States.

...
setwd("/Users/claudiacassidy/DS/college")
getwd()
#dd <- read.delim('oe.data.1.AllData.txt') 
...
##### After cleaning up the data, I wanted to group colleges in a meaningful way. The right fit for a student at a college might be better related to their SAT scores.  Without data about GPA or campus culture, I decided that it might be most useful to group colleges by their SAT scores.  Students with similar SAT scores would likely fit in better with other students who had similar scores. For example, if a school's average SAT scores are much higher than the student's SAT scores, then the student might find herself lost and stressed at the intensity of the pace of learning.  

...
##### Since colleges select the highest scores in each category and students are able to retake the SAT as many times as they'd like, it's possible that students in higher income homes were able to pay to have SAT preparation courses and to take the exam several times more than students who could not afford to do that.
